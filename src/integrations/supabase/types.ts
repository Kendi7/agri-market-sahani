  ...
  public: {
    Tables: {
      ...
      farmer_inventory: {
        ...
        Relationships: [
          {
            foreignKeyName: "farmer_inventory_crop_id_fkey"
            columns: ["crop_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "farmer_inventory_farmer_id_fkey"
            columns: ["farmer_id"]
            isOneToOne: false
      ...
      orders: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "farmer_inventory"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Enums: {
      crop_category: "cereals" | "vegetables" | "fruits" | "cash_crops"
      order_status:
        | "pending"
        | "confirmed"
        | "in_transit"
      ...
      payment_status:
        ...
        | "failed"
        | "refunded"
      quality_grade: "grade_1" | "grade_2" | "grade_3"
